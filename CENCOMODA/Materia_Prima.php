...
<body>
	...
	<section class="full-width pageContent">
		...
		<h3 class="text-center tittles">Materia Prima</h3>
		<div class="Materiaprim">
			<?php

				$ultimoRegistro = $Materia_Prima->consultarGestion("tab_materia_prima");
				...
				<?php
					if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
						if (empty($_POST["tela"]) ||
							...
							$valores = array($_POST["tela"],  $_POST["Cantidad1"], $_POST["Color"], $_POST["insumos"], $_POST["Cantidad2"]);
							$Materia_Prima->insertarGestion("tab_materia_prima", $valores);
						}
					}
				?>	
		</div>
