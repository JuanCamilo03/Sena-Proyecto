...
<body>
	...
	<section class="full-width pageContent">
		...
		<h4 class="text-center tittles">Proovedores</h4>
		<div class="Proovedores">
			<?php

				$ultimoRegistro = $Proovedores->consultarGestion("tab_proovedores");
			...
			<form method="POST">
				...
				<select name="prov" id="prov">
				  <option value="Facol">Facol</option>
				  <option value="Lafayette">Lafayette</option>
				  <option value="Telas Medellin">Telas Medellin</option>
				  <option value="Pash SAS">Pash SAS</option>
				  <option value="Cristian Parado">Cristina Parado</option>
				  <option value="Fabian Quintero">Fabian Quintero</option>
				  <option value="Portofino">Portofino</option>
				  <option value="Portotela">Portotela</option>
				</select>
				<br>
				<br>
			...
			<?php
					if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
						if (empty($_POST["prov"]) ||
							...
							$valores = array($_POST["prov"], $_POST["tela"],  $_POST["Color"], $_POST["Cantidad1"], $_POST["insumos"], $_POST["Cantidad2"], $_POST["fechaAgregado"]);
							$Proovedores->insertarGestion("tab_proovedores",$valores);
						}
					}
				?>
		</div>
